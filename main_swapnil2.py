...
from lipreading.model_swap import Lipreading
...
def load_args(default_config=None):
    ...
    parser.add_argument('--batch-size', type=int, default=30, help='Mini-batch size')
...
#     logger = get_logger(args, save_path)
    ...
    while epoch < args.epochs:
        model = train(model, dset_loaders['train'], criterion, epoch, optimizer, None)
